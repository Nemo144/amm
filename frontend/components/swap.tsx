...
export const Swap = ({ pools }: SwapProps) => {
  ...
  //define the uniqueTokens variable for the swap
  const uniqueTokens = pools.reduce((acc, pool) => {
    //define the variables for the tokens
  ...
  //define the estimateSwapOutput function
  ...
  //define the effect hook for the side effects
  useEffect(() => {
    estimateSwapOutput();
